...
import { messages as edocument } from "@/features/edocument/messages";
import { messages as reservation } from "@/features/reservation/messages";

/** พจนานุกรม UI ทั้งระบบ — feature ใหม่เพิ่มบรรทัด import ที่นี่ · key ต้องไม่ซ้ำข้าม feature */
export const UI_MESSAGES: Dictionary = { ...core, ...identity, ...sample, ...news, ...personnel, ...curriculum, ...edocument, ...reservation };
